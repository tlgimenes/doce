...
describe("ToolDisclosure", () => {
  ...
  it("uses the redesigned compact header rhythm", () => {
    render(
      <ToolDisclosure
    ...
    expect(screen.getByTestId("tool-disclosure")).toHaveClass(
      "overflow-hidden",
      "rounded-md",
      "shadow-sm",
    );
    expect(screen.getByTestId("tool-summary")).toHaveClass("px-3", "py-2");
  });
});
